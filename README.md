...
| 🐧 OS | ⚡ CPU | 🧠 RAM | 🎮 GPU | 🖥️ Display |
|---|---|---|---|---|
| CachyOS · niri · Wayland | Ryzen 5 3600 · 6C/12T | 32 GiB DDR4-2666 dual | RX 6800 · 16 GB · RADV | 2560×1440 · 165 Hz |

| 💾 Storage | 🔧 Proton | 📦 Mesa | 🎯 Gamescope | 📊 MangoHud |
|---|---|---|---|---|
| NVMe 980 + SATA + WD | Proton-CachyOS 11 | 26.1.6 | 3.16.25 | 0.8.4 |
